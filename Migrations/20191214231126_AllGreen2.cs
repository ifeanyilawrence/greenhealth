...
{
    public partial class AllGreen2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhysicianId1 = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctors", x => x.PhysicianId);
                    table.ForeignKey(
                        name: "FK_Doctors_AspNetUsers_PhysicianId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorPhysicianId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Appointments_Doctors_DoctorPhysicianId",
                        column: x => x.DoctorPhysicianId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClinicRemarks = table.Column<string>(nullable: false),
                    ...
                    PatientId = table.Column<int>(nullable: false),
                    DoctorPhysicianId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attendances_Doctors_DoctorPhysicianId",
                        column: x => x.DoctorPhysicianId,
                        principalTable: "Doctors",
                        principalColumn: "PhysicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DoctorPhysicianId",
                table: "Appointments",
                column: "DoctorPhysicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_DoctorPhysicianId",
                table: "Attendances",
                column: "DoctorPhysicianId");
