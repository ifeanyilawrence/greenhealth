...
using static GreenHealth.Models.MyTimeBlockExtension;
...
namespace GreenHealth.Models
{
    public class BusinessLogic
    {
            ...
            //    TimeRange workingHours = new TimeRange(TimeTrim.Hour(start, int.Parse(db..Find(2).Value)), TimeTrim.Hour(start, int.Parse(db.Administrations.Find(3).Value)));
            ...
            //    AppDbContext db = new AppDbContext();
            //    int A, S, E;
            //    A = int.Parse(db.Admin.Find(1).Value);
